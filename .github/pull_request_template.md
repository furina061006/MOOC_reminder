...
- [ ] 改了抓取/解析的，`src/shared/icourse163-api.js` 与 SW 内联的 `apiExtractHomework` 两份拷贝已同步（CLAUDE.md 不变量 12）
- [ ] 改了平台行为或不变量的，已同步更新 `.claude/CLAUDE.md`
- [ ] 用户能感知到的变化，已写入 `.claude/logs/changelog.md`
