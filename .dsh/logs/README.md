...
| 日期 | 主题 |
| --- | --- |
| 2026-09-23 | [backlog 复核清理 + popup 启动耗时埋点](2026-09-23-backlog-cleanup-and-popup-timing.md) |
| 2026-09-23 | [发布 1.1.2（幽灵课程修复）](2026-09-23-release-1.1.2.md) |
| 2026-09-22 | [发布 1.1.1（并把一个落错分支的提交捞回来）](2026-09-22-release-1.1.1.md) |
| 2026-09-22 | [「设置页说我还是 v1.0.0」：三个 bug 与一条不变量](2026-09-22-update-status-stale-and-failed-check.md) |
